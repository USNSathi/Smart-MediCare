	...
	const validateStepOne = async (
		...
		validateStepTwo = async (
			...
			if (
				...
				const address = () => {
						...
						address += $("#district").children(":selected").text() + ", "

						address += $("#division").children(":selected").text()

						return address
					},
					data = {
						phone: $("#phone").val() == "" ? null : "+88" + $("#phone").val(),
						mobile:
							$("#mobile").val() == "" ? null : "+88" + $("#mobile").val(),
		...
		validateStepFive = async (
			...
			const data = {
				...
				adminMobile: "+88" + $("#adminMobile").val(),
				...
				data = {
					...
					capacity: {
						...
						cabin: $("#cabin").is(":checked")
							...
							: null,
						vip_cabin: $("#vipCabin").is(":checked")
							? parseInt($("#vipCabinCount").val() as string)
							: null,
						icu: $("#icu").is(":checked")
						...
						ccu: $("#ccu").is(":checked")
							...
							: null,
						hdu: $("#hdu").is(":checked")
							? parseInt($("#hduCount").val() as string)
							: null,
						hfncu: $("#hfncu").is(":checked")
							? parseInt($("#hfncuCount").val() as string)
							: null,
						emergency: $("#emergency").is(":checked")
							? parseInt($("#emergencyCount").val() as string)
							: null,
						covid: $("#covid").is(":checked")
							? parseInt($("#covidCount").val() as string)
							: null,
						extra: $("#extra").is(":checked")
							? parseInt($("#extraCount").val() as string)
							: null,
					},
					vacant_bed_log: {
						registration_no: $("#registrationNo").val(),
		...
		<>
			...
			>
				<div className="row mx-0 justify-content-center my-5">
					<div className="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5 px-3 px-md-4 px-lg-5 card shadow-lg rounded-lg">
							...
							>
								...
								*/}
								...
								>
									...
									<li className="d-inline-block ml-1 ml-sm-3 ml-md-4">
										<div
											className="bg-light border border-primary rounded-circle d-flex justify-content-center align-items-center h6"
											style={{ width: "30px", height: "30px" }}
										>
								...
								<div className="progress mt-n4 mb-5">
									<div
								...
								<fieldset>
									<div className="form-card">
										...
										<div
											className="row mx-0 mb-4 text-primary"
											id="hospitalType"
										>
											<div className="form-check col d-flex flex-row-reverse">
												<input
													className="form-check-input ml-0 w-25"
													type="radio"
													name="hospitalType"
													id="public"
													value="Public"
												...
												/>
												<label
													className="form-check-label ml-4 mr-auto"
									...
									<div className="mt-3 text-secondary">
										<small className="mr-4 mb-1">* - required</small>
									</div>
								...
								<fieldset>
									<div className="form-card">
										...
										<div className="form-row mx-0 mb-3">
											...
											<small
												className="d-block text-danger pl-1"
												id="coordinateErr"
											></small>
										</div>
									</div>
									<button
										type="button"
										className="btn btn-dark previous action-button-previous mr-2"
									>
								...
								<fieldset>
									...
									<button className="btn btn-dark previous action-button-previous mr-2">
										<i className="bi bi-arrow-left"></i>
									</button>
									<button
										className="btn btn-primary next action-button w-50"
